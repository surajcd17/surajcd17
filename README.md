...
<h3 align="center">CSE - AIML Student at PES University</h3>
...
## 📂 What I'm Working On
- Strengthening programming  in **C, Python & JavaScript**  
- Learning **MERN stack** 
- Exploring beginner-level **AI/ML concepts**
  

### 🔧 Active Projects
- **[T_C-summarizer](https://github.com/surajcd17/T_C-summarizer)** –A Chrome Extension that automatically summarizes the Terms & Conditions (T&C) or Privacy Policy of any website using a local Python backend. Useful for quickly understanding how websites use your data.
- **[Transaction_Data_Fetcher](https://github.com/surajcd17/Transaction_Data_Fetcher)** – A CLI tool to fetch and summarize Bitcoin transaction data using public API.
